...
class CrudControllerUrl extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-controller-url {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD URL controller';
 ...
 /**
    ...
    {
        return __DIR__.'/../stubs/crud-controller-url.stub';
    }
