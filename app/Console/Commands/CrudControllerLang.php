...
class CrudControllerLang extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-controller-lang {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD Lang controller';
 ...
 /**
    ...
    {
        return __DIR__.'/../stubs/crud-controller-lang.stub';
    }
