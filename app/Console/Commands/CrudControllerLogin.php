...
class CrudControllerLogin extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-controller-login {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD Login controller';
 ...
 /**
    ...
    {
        return __DIR__.'/../stubs/crud-controller-login.stub';
    }
