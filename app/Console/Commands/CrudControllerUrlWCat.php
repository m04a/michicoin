...
class CrudControllerUrlWCat extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-controller-url-wcat {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD URL controller with category';
 ...
 /**
    ...
    {
        return __DIR__.'/../stubs/crud-controller-url-wcat.stub';
    }
