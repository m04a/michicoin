...
class ControllerLogin extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:controller-login {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack Login controller';
 ...
 /**
    ...
    {
        return __DIR__.'/../stubs/controller-login.stub';
    }
