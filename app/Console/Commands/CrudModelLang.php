...
class CrudModelLang extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-model-lang {name}';
...
/**
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD Lang model';
    ...
    {
        return __DIR__.'/../stubs/crud-model-lang.stub';
    }
