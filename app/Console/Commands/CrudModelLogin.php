...
class CrudModelLogin extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fnx7:crud-model-login {name}';
...
/**
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD Login model';
    ...
    {
        return __DIR__.'/../stubs/crud-model-login.stub';
    }
