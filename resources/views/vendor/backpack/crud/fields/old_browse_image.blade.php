    ...
    <div class="controls text-center js-change-browse-image-check">
	    ...
	    <div class="input-group ">
			...
			<span class="input-group-append">
			  	<button type="button" data-inputid="{{ $field['name'] }}-filemanager" class="btn btn-light btn-sm popup_selector"><i class="la la-folder-open"></i> {{ trans('backpack::crud.browse_uploads') }}</button>
