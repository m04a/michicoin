...
@if(is_array($items))
    ...
    <div class="input-group input-group-sm mb-3">
        <div class="text-center w-100">
            <img src="{{url($v)}}" class="image mx-auto  img-fluid" alt="{{url($v)}}">
        </div>

            <input type="text" @include('crud::fields.inc.attributes') value="{{$v}}" readonly>
    ...
    <script type="text/html" data-marker="browse_multiple_template">
        <div class="input-group input-group-sm mb-3">
        <div class="text-center w-100">
            <img src="" class="image mx-auto  img-fluid" alt="">
    </div>
                ...
                if ($input.val() != '' && $input.val() != null && $multiple === 'true') {
                    ...
                    if (Array.isArray($paths) && $paths.length) {
                        ...
                        $paths.forEach(function (path) {
                            ...
                            newInput.find('img').attr('src','{{url('')}}/'+path);
